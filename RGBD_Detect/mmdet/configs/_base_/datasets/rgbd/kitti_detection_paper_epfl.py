...
img_norm_cfg = dict(mean=[93.83309082, 98.76049672, 95.87739305], std=[78.78147396, 80.1303281, 81.19954495],
                    to_rgb=True, dmean=[93.83309082, 98.76049672, 95.87739305],
                    dstd=[78.78147396, 80.1303281, 81.19954495])
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(512, 448), (416, 416)], keep_ratio=True),
