...
class fusionnet_CBAM_RGBD11(BaseModule):
    def __init__(self,
                 init_cfg=None
                 ):
        super(fusionnet_CBAM_RGBD11, self).__init__(init_cfg)
        ...
        self.cbam_layer2 = CBAMCrossOur(512, 32)
        self.cbam_layer3 = CBAMCrossOur(1024, 64)
        self.cbam_layer4 = CBAMCrossOur(2048, 64)
    ...
    def train(self, mode=True):
        super(fusionnet_CBAM_RGBD11, self).train(mode)
        self._freeze_stages()
