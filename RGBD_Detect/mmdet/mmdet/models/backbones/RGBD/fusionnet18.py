...
class FusionNet34(BaseModule):
    ...
    def forward(self, x):
        ...
        # block 2
        rgb = self.encodergb_layer2(fuse)
        ...
        # block 3
        rgb = self.encodergb_layer3(fuse)
        ...
        # block 4
        rgb = self.encodergb_layer4(fuse)
    ...
    def train(self, mode=True):
        super(FusionNet34, self).train(mode)
