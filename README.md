...
the code is based on [**mmdetection**](https://github.com/open-mmlab/mmdetection). Therefore, the mmdetection is needed to install according to their guidelines. Then replace the mmdet file we provided

### Prepare the dataset

Take the KITTI dataset as an example,First download the dataset and create some directories first. The HHA data obtained from the previous section or you can directly download from [**here**]()
...
Then createjson file by run the code createjson.py
